...
STRAT_PARAMS = {
    ...
    "guppy": {
        ...
        #                           "decimals": 1},
        # "tsl_size_short": {"name": "Trailing SL size for shorts (%): ", "type": float, "min": 0.1, "max": 3.0,
        #                            "decimals": 1},
        # "band6_cushion_long": {"name": "Cushion for moving sl behind Guppy Band 6 on longs (%): ", "type": float,
        #                        "min": 0.1, "max": 0.6, "decimals": 1},
        # "band6_cushion_short": {"name": "Cushion for moving sl behind Guppy Band 6 on shorts (%): ", "type": float,
        #                         "min": 0.1, "max": 0.6, "decimals": 1},
        # "gsl_moveto_long": {"name": "Guppy semi-trailing sl move initially to (longs): 1. Break even, 2. Min RR",
        #                             "type": int, "min": 1, "max": 2},
        # "gsl_moveto_short": {"name": "Guppy semi-trailing sl move initially to (shorts): 1. Break even, 2. Min RR",
        #                              "type": int, "min": 1, "max": 2},
        ...
        "sl_long": {"name": "SL for longs", "type": float, "min": 0.1, "max": 2.5, "decimals": 1},
        "sl_short": {"name": "SL for shorts", "type": float, "min": 0.1, "max": 2.5, "decimals": 1},
        "mfi_long": {"name": "Use MFI for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "mfi_short": {"name": "Use MFI for shorts? (Y/N)", "type": Y_N, "choices": ["n"]},
        "mfi_period": {"name": "MFI Period", "type": int, "min": 2, "max": 2},
        "mfi_mult": {"name": "MFI area multiplier", "type": int, "min": 2, "max": 2},
        "mfi_ypos": {"name": "MFI ypos", "type": float, "min": 1.0, "max": 1.0, "decimals": 1},
        "mfi_long_threshold": {"name": "MFI threshold for longs", "type": float, "min": 0.0, "max": 0.0,
                               "decimals": 1},
        "mfi_short_threshold": {"name": "MFI threshold for shorts", "type": float, "min": 0.0, "max": 0.0,
                                "decimals": 1},
        "macd_long": {"name": "Use MACD for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "macd_short": {"name": "Use MACD for shorts (Y/N)", "type": Y_N, "choices": ["n"]},
        "macd_fast": {"name": "MACD fast length", "type": int, "min": 2, "max": 2},
        "macd_slow": {"name": "MACD slow length", "type": int, "min": 3, "max": 3},
        "macd_signal": {"name": "MACD signal length", "type": int, "min": 2, "max": 2},
        "rsi_long": {"name": "Use RSI for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "rsi_short": {"name": "Use RSI for shorts (Y/N)", "type": Y_N, "choices": ["n"]},
        "rsi_length": {"name": "RSI length", "type": int, "min": 2, "max": 2},
        "rsi_overbought": {"name": "RSI overbought value", "type": int, "min": 50, "max": 50},
        "rsi_oversold": {"name": "RSI oversold value", "type": int, "min": 50, "max": 50},
        "adx_long": {"name": "Use ADX for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "adx_short": {"name": "Use ADX for shorts (Y/N)", "type": Y_N, "choices": ["n"]},
        "adx_smoothing": {"name": "ADX smoothing", "type": int, "min": 5, "max": 5},
        "adx_di_length": {"name": "ADX DI length", "type": int, "min": 10, "max": 10},
        "adx_length_long": {"name": "ADX length for longs", "type": float, "min": 10.0, "max": 10.0, "decimals": 1},
        "adx_length_short": {"name": "ADX length for shorts", "type": float, "min": 10.0, "max": 10.0, "decimals": 1},
        "bb_long": {"name": "Use Bollinger Bands for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "bb_short": {"name": "Use Bollinger Bands for shorts (Y/N)", "type": Y_N, "choices": ["n"]},
        "bb_length": {"name": "Bollinger Band length", "type": int, "min": 5, "max": 5},
        "bb_mult": {"name": "Bollinger Band Standard Dev. Multiplier", "type": float, "min": 1.0,
                    "max": 1.0, "decimals": 1},
        "wae_long": {"name": "Use WAE for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "wae_short": {"name": "Use WAE for shorts (Y/N)", "type": Y_N, "choices": ["n"]},
        ...
        "wae_expl_check": {"name": "Only trade if explosion line is over Deadzone (Y/N)", "type": Y_N,
                           "choices": ["n"]},
        "ema200_long": {"name": "Use 200 EMA for longs? (Y/N)", "type": Y_N, "choices": ["n"]},
        "ema200_short": {"name": "Use 200 EMA for shorts? (Y/N)", "type": Y_N, "choices": ["n"]},
        "guppy_fast_long": {"name": "Use guppy fast ribbon for longs? (Y/N)", "type": Y_N, "choices": ["y"]},
        "guppy_fast_short": {"name": "Use guppy fast ribbon for shorts? (Y/N)", "type": Y_N, "choices": ["y"]},
        "ribbon_check_long": {"name": "Don't enter longs unless price closes above: [Fast Band (1-6), Slow Band (7-12),"
                                      " Off (13)]", "type": int, "min": 1, "max": 13},
        "ribbon_check_short": {"name": "Don't enter shorts unless price closes below: [Fast Band (1-6), Slow Band ("
                                       "7-12), Off (13)]", "type": int, "min": 1, "max": 13},
        ...
        "tp_long": {"name": "Number of TPs on longs (Max 3)", "type": int, "min": 1, "max": 1},
        "tp_short": {"name": "Number of TPs on shorts (Max 3)", "type": int, "min": 1, "max": 1},
        "ltp1": {"name": "TP1 (%) for longs", "type": float, "min": 1, "max": 1, "decimals": 1},
        "ltp1_qty": {"name": "% of trade to close at TP1 (long)", "type": float, "min": 100.0, "max": 100.0,
                     "decimals": 1},
        "ltp2": {"name": "TP2 (%) for longs", "type": float, "min": 1, "max": 1, "decimals": 1},
        "ltp2_qty": {"name": "% of trade to close at TP2 (long)", "type": float, "min": 1, "max": 1,
                     "decimals": 1},
        "ltp3": {"name": "TP3 (%) for longs", "type": float, "min": 1, "max": 1, "decimals": 1},
        "stp1": {"name": "TP1 (%) for shorts", "type": float, "min": 1, "max": 1, "decimals": 1},
        "stp1_qty": {"name": "% of trade to close at TP1 (short)", "type": float, "min": 100.0, "max": 100.0,
                     "decimals": 1},
        "stp2": {"name": "TP2 (%) for shorts", "type": float, "min": 1, "max": 1, "decimals": 1},
        "stp2_qty": {"name": "% of trade to close at TP2 (short)", "type": float, "min": 1, "max": 1,
                     "decimals": 1},
